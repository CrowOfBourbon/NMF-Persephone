...
#define SERVICE_ROLES list(/datum/job/chaplain, /datum/job/bartender, /datum/job/chef, /datum/job/hydro, /datum/job/janitor, /datum/job/journalist, /datum/job/librarian, /datum/job/merchant)
...
#define INDEP_ROLES list(/datum/job/visitor, /datum/job/consular, /datum/job/journalist)
