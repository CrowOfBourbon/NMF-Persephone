...
/mob/living/carbon/human/centcomm_timeout()
	...
	if(spawnpos && istype(spawnpos))
		to_chat(src, "<span class='warning'>You come to the sudden realization that you never left the Persephone at all! You were in cryo the whole time!</span>")
...
/mob/living/silicon/robot/centcomm_timeout()
	...
	if(spawnpos && istype(spawnpos))
		to_chat(src, "<span class='warning'>You come to the sudden realization that you never left the Persephone at all! You were in robotic storage the whole time!</span>")
		src.forceMove(pick(spawnpos.turfs))
