...
/obj/item/gun/energy/gun/skrell/pistol
	name = "Elodile particle pistol"
	desc = "An Elodile Empiure particle-beam pistol with two settings: Disable and Lethal."
...
/obj/item/gun/energy/gun/skrell/smg
	name = "Elodile particle submachinegun"
	desc = "An Elodile Empire particle-beam submachine gun with two settings: Disable and Lethal."
