/datum/accent/mhous_tum
	...
	language remains relatively unchanged from the time of the ancient God-Kings called Ensi, and as a result it’s difficult to learn. There is only one dialect."
	tag_icon = "mos"
