...
/obj/item/clothing/head/vaurca_breeder
	name = "xal representative shroud"
	desc = "Large shroud used by Xallian representatives."
...
/obj/item/clothing/head/cthur_breeder
	name = "empire of queens representative shroud"
	desc = "Large shroud used by E.O.Q representatives."
	icon = 'icons/mob/species/breeder/inventory.dmi'
