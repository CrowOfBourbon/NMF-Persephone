...
/datum/event/rescue_pod/announce()
    if(prob(66))
        command_announcement.Announce("The NDV Styx reports an escape pod inbound to the [station_name()]. Investigate and attend to the situation in accordance with NanoTrasen corporate regulations.", new_title="NDV Styx", new_sound='sound/AI/escapepod.ogg')
