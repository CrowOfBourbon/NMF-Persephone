...
/decl/reagent/alcohol/thirdincident
	...
	color = "#1936a0"
	strength = 10
	description = "A controversial drink popular with the punk youth of the Elodile Empire's Aquatics. Represents blood, eggs, and tears."
	taste_description = "genophage sadness"

	glass_icon_state = "thirdincident"
	glass_name = "glass of the Third Incident"
	glass_desc = "A controversial drink popular with the punk youth of the Elodile Empire's Aquatics. Represents blood, eggs, and tears."
