...
/obj/item/reagent_containers/food/drinks/bottle/victorygin
	...
	stations, due to a contract that allows the government to supply the corporation, and in the Tajaran communities of the Interstellar Republic. The destruction of Victory Gin's bottles and reserves \
