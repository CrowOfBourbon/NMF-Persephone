...
/mob/living/carbon/human/type_a/cargo/Initialize(mapload)
	...
	switch(hive[length(hive)])
		if("Tilla")
			change_skin_color(255, 211, 0)
		if("Ti'aksi")
			change_skin_color(38, 20, 42)
		if("Va'saari")
			change_skin_color(38, 20, 42)
		if("Kandros`kiaksi")
			change_skin_color(38, 20, 42)
		if("Xal")
			change_skin_color(1, 40, 31)
...
/mob/living/carbon/human/terminator/Initialize(mapload)
	...
	add_language(LANGUAGE_NEW_MANDARIN, 1)
	add_language(LANGUAGE_MHOSTUM, 1)
	add_language(LANGUAGE_SIIK_MAAS, 1)
	add_language(LANGUAGE_TUQ, 1)
	add_language(LANGUAGE_LUNIAN, 1)
	add_language(LANGUAGE_MARTIAN, 1)
