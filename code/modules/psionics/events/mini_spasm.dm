...
/datum/event/minispasm/announce()
	command_announcement.Announce( \
		...
		"Elodile Empire Observation Probe TC-203 Sensor Array", new_sound = 'sound/misc/announcements/security_level_old.ogg')
...
/datum/event/minispasm/end()
	command_announcement.Announce( \
		...
		"Elodile Empire Observation Probe TC-203 Sensor Array", new_sound = 'sound/misc/announcements/nightlight_old.ogg')
